...
- **Excel** (Pivot Tables, Power Query, Dashboarding, VBA basics)  
- **Power BI** (Custom visuals, KPI dashboards, report automation)  
- **Tableau** (Interactive dashboards, storyboards)  
- **Jupyter Notebook** (Data exploration & visualization)

**Cloud & Infrastructure:**  
- **Amazon Web Services (AWS)** – S3, EC2 (basics)  
- **Microsoft Azure** – Data Studio, Azure SQL  
...
- 🌐 [Portfolio Website](https://giraysengonul.cv/) <!-- replace with actual link -->
